...
class Server(threading.Thread):
    def __init__(self):
        ...
        self.in_stream.bind("tcp://127.0.0.1:%d" % INPUT_PORT)
        self.out_stream.bind("tcp://127.0.0.1:%d" % OUTPUT_PORT)
    ...
    def run(self):
        print ("Server running and listening at tcp://127.0.0.1%d" % INPUT_PORT)
